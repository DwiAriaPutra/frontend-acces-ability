...
export const loginUser = async (
  ...
  export const getGoogleAuthUrl = async (): Promise<{
    ...
    try {
      ...
      if (result.success && authUrl) {
        console.log("[API Success] getGoogleAuthUrl: Authorization URL retrieved");
        return {
          success: true,
      ...
      console.error("[API Error] getGoogleAuthUrl: Invalid response format", result);
      return {
        success: false,
  ...
  export const handleGoogleCallback = async (
    ...
    try {
      ...
      console.error("[API Error] handleGoogleCallback: Invalid response format", result);
      return {
        success: false,
