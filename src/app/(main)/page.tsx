...
export default function Home() {
  ...
  return (
    <>
      ...
      <section className="relative pt-20">
        ...
        >
          ...
          <div className="relative z-10 w-full flex flex-col items-center justify-center">
            ...
            <p className="mt-5 md:mt-6 text-white max-w-2xl text-base md:text-lg italic">
              Temukan bantuan komunikasi bahasa isyarat, pendampingan mobilitas,
              dan layanan terapi profesional yang dirancang untuk mendukung
              kemandirian Anda.
            </p>
            {/* Action Buttons */}
            <div className="mt-8 flex w-full flex-col sm:w-auto sm:flex-row sm:flex-wrap justify-center gap-4">
              <Link
                href="/login"
                className="bg-brand-green text-white px-8 py-3 rounded-md font-medium shadow-md hover:bg-brand-green-hover transition text-center"
              >
                Cari Pendamping
              </Link>
              <Link
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-brand-green text-white p-8 rounded-xl flex flex-col items-center text-center transition hover:scale-105 duration-300">
            ...
            <p className="text-sm opacity-90 leading-relaxed">
              Penerjemah Bahasa Isyarat dan Transcriber
            </p>
          </div>
          {/* Service Card 2 */}
          <div className="bg-brand-green text-white p-8 rounded-xl flex flex-col items-center text-center transition hover:scale-105 duration-300">
            ...
            <p className="text-sm opacity-90 leading-relaxed">
              Pendamping Event dan Asisten Pribadi
            </p>
          </div>
          {/* Service Card 3 */}
          <div className="bg-brand-green text-white p-8 rounded-xl flex flex-col items-center text-center transition hover:scale-105 duration-300">
            ...
            <p className="text-sm opacity-90 leading-relaxed">
              Pendamping Tunanetra dan Asisten Perjalanan
            </p>
          </div>
          {/* Service Card 4 */}
          <div className="bg-brand-green text-white p-8 rounded-xl flex flex-col items-center text-center transition hover:scale-105 duration-300">
            ...
            <p className="text-sm opacity-90 leading-relaxed">
              Terapis Wicara dan Guru Pendamping
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-14 md:py-20 bg-gray-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 text-center">
          <h2 className="text-3xl font-bold text-gray-900">
            Cara Kerja ACCESS-ABILITY
          </h2>
          <p className="text-gray-500 mt-2">
            Proses sederhana untuk menghubungkan pengguna dengan pendamping
            profesional
          </p>
          <div className="mt-20 relative">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative">
              ...
              <div className="flex flex-col items-center">
                <div className="w-24 h-24 rounded-full bg-green-200 border-4 border-white flex items-center justify-center text-3xl font-bold text-brand-green z-10 mb-6">
                  1
                </div>
                <h4 className="font-bold text-lg mb-2">Daftar</h4>
                <p className="text-gray-500 text-sm max-w-[200px]">
                  Pengguna membuat akun untuk menggunakan layanan.
                </p>
              </div>
              {/* Step 2 */}
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-500 text-sm max-w-[200px]">
                  Gunakan fitur pencarian untuk menemukan pendamping sesuai
                  kebutuhan.
                </p>
              </div>
              {/* Step 3 */}
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-500 text-sm max-w-[200px]">
                  Pilih penyedia layanan dan lakukan pemesanan.
                </p>
              </div>
              {/* Step 4 */}
              <div className="flex flex-col items-center">
                <div className="w-24 h-24 rounded-full bg-brand-green border-4 border-white flex items-center justify-center text-3xl font-bold text-white z-10 mb-6">
                  4
                </div>
                <h4 className="font-bold text-lg mb-2">Layanan Dilakukan</h4>
                <p className="text-gray-500 text-sm max-w-[200px]">
                  Pendamping memberikan layanan sesuai jadwal yang telah
                  disepakati.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="max-w-xl text-white">
            <h2 className="text-3xl md:text-4xl font-bold leading-tight mb-4">
              Butuh Pendamping Disabilitas?
              <br />
              Temukan di ACCESS-ABILITY
            </h2>
      ...
      <section
        id="tentang-kami"
        className="py-14 md:py-20 max-w-7xl mx-auto px-4"
      >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="bg-white border rounded-xl p-8 shadow-sm">
            <div className="flex items-center mb-4">
              <img
                alt="BEM UNIV"
                className="w-14 h-14 rounded-full border-4 border-brand-green"
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuBVxUdyCHI5znjjMr4_ool9HDYs-37_fUtllOtgvTd-G1uKAUynOq8DttJO6ldz_NgbP19AeklT6Oh_3ju3_18huT0yS3CLsy1ZGFLyPHPrePviUwTB8JIFt_Y_7I7jWN1jR9xHWaXWc5To1Xb5KQpjXf7CKfOVotvQb_jZn_zMj7YF-X6gQnIl6gYF7FFcLJNnVSbAOyDswSp5Fzyik5NMaRvqN7hqb_PIvs3xkYVuRV7pRTy614C92kLCNY6tbEI_YXV2Yuqo1jc"
              />
              <div className="ml-4">
            ...
            <p className="text-sm text-gray-600 italic leading-relaxed">
              &quot;ACCESS-ABILITY sangat membantu saya menemukan juru bahasa
              isyarat untuk acara seminar kampus.&quot;
            </p>
          </div>
          {/* Testimonial 2 */}
          <div className="bg-white border rounded-xl p-8 shadow-sm">
            ...
            <p className="text-sm text-gray-600 italic leading-relaxed">
              &quot;Sebagai penyedia layanan JBI, platform ini membantu saya
          ...
          <div className="bg-white border rounded-xl p-8 shadow-sm">
            ...
            <p className="text-sm text-gray-600 italic leading-relaxed">
              &quot;Platform ini memudahkan kami mencari pendamping bagi peserta
              disabilitas dalam kegiatan komunitas.&quot;
            </p>
          </div>
        </div>
      </section>
